...
module.exports = (client) => {
  ...
  app.get("/discord", (req, res) => {
    res.redirect("https://discord.gg/YV382UR");
  });
  ...
  app.get("/invite", (req, res) => {
    res.redirect("https://discordapp.com/oauth2/authorize?client_id=546490972901605386&permissions=8&scope=bot");
  });

  app.get("/status", (req, res) => {
    res.redirect("https://status.shiber.xyz");
  });
  ...
  app.get("/sponsors", (req, res) => {
    renderTemplate(res, req, "sponsors.ejs")
  });

  app.get("/donate", (req, res) => {
    res.redirect("https://patreon.com/join/MrDioogo")
  })
