...
class Forget extends Command {
  ...
  async run ({message, args, level, reply}, t) { // eslint-disable-line no-unused-vars
    ...
    Infractions.findOne({
      ...
      reply(t("commands:forget.sucess", { warns: warnsToR, user: user.user.tag }));
    });
  }
}
